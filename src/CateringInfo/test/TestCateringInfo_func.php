...
class TestCateringInfo extends PHPUnit_Framework_TestCase{
    ...
    protected function setUp(){
        ...
        $q_pdo->exec($initSql2);
        $initSql3="INSERT INTO merchant_dish_relation (merchant_id, dish_1,dish_2,dish_3,dish_4,dish_5,dish_6) VALUES (90002, 90001, 90002, 90003, 90004, 90005, 90006)";
        $q_pdo->exec($initSql3);
...
//        $this->assertEquals($expect,$result,"获取分页成功用例");
    ...
    protected function tearDownData(){
        ...
        $q_pdo->exec($delSql);
        $delSql1="DELETE FROM dish_list WHERE ID in(90001,90002,90003,90004,90005,90006)";
        $q_pdo->exec($delSql1);
